...
namespace Problem2StudentsByGroup
{
    class Problem2StudentsByGroup
    {
        static void Main(string[] args)
        {
            ...
            foreach (var stundent in groupNumber)
            {
                Console.WriteLine("{0} {1},Group number {2}", stundent.FirstName, stundent.LastName, stundent.groupNumber);
            }
