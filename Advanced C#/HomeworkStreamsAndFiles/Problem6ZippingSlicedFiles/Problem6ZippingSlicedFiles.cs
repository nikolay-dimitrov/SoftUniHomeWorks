...
namespace Problem6ZippingSlicedFiles
{
    ...
    static void Main()
    {
        ...
        //Again you need to check out the dirrectory for the result:HomeworkStreamsAndFiles\Problem6ZippingSlicedFiles\parts
    }
    }
}