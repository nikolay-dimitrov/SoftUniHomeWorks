...
namespace Problem7FilterStudentsByPhone
{
    class Problem7FilterStudentsByPhone
    {
        static void Main(string[] args)
        {
            ...
            var sofianNumbers =
                ...
                where stundent.phone.StartsWith("02") || stundent.phone.StartsWith("+3592") || stundent.phone.StartsWith("+359 2")
                select stundent;

            foreach (var stundent in sofianNumbers)
            {
                Console.WriteLine(stundent.FirstName + " " + stundent.LastName + "-->" + stundent.phone);
            }
        }
    }
}
